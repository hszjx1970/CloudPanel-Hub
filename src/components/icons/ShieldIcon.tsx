...
export const ShieldIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg viewBox="0 0 256 256" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
        <path d="M128 24C65.8 24 24 68.34 24 123.66C24 173.34 61.12 214.38 105.62 225.02C106.946 225.323 108.312 225.467 109.68 225.45C114.72 225.45 118.8 221.37 118.8 216.33V213.1C118.8 208.06 122.88 204.02 127.92 204.02H156.48C161.52 204.02 165.6 208.06 165.6 213.1V220.53C165.599 225.57 169.679 229.65 174.719 229.65C176.439 229.664 178.146 229.431 179.769 228.98C228.469 215.17 256 174.13 256 124.45C256 69.13 214.2 24.79 159 24.79" fill="currentColor" fillOpacity="0.8"/>
